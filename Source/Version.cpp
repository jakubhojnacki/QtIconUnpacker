...
void Version::setMajor(const int pMajor) {
    this->mMajor = pMajor;
}

void Version::setMinor(const int pMinor) {
    this->mMinor = pMinor;
}

void Version::setHotfix(const int pHotfix) {
    this->mHotfix = pHotfix;
}

void Version::setBuild(const int pBuild) {
    this->mBuild = pBuild;
}
